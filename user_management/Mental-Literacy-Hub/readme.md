...
This project aims to promote mental well-being and awareness through a digital, interactive platform.
...
1. **Clone the Repository**
   ```bash
   git clone https://github.com/miftahr149/Mental-Literacy-Hub
   ```
