...
/**
 * Frontend-only controller - serves JSP views only Backend logic to be added later
 */
@Controller
...
public class UserManagementController {
    ...
    /**
     * View Profile - Frontend only GET /user-management/profile
     */
    @GetMapping("/profile")
    ...
    /**
     * Edit Profile - Frontend only GET /user-management/profile/edit
     */
    ...
    /**
     * Update Profile - POST handler POST /user-management/profile/edit
     */
                    ...
                    try {
                        ...
                        if (contentType != null && contentType.startsWith("image/")) {
                            ...
                            String uploadDir = request.getServletContext()
                                    .getRealPath("/uploads/profile-pictures/");
                            if (uploadDir == null) {
                                // Fallback: use relative path from webapp root
                            ...
                            String newFilename = "profile_" + userId + "_"
                                    + UUID.randomUUID().toString() + extension;

                            // Delete old profile picture if exists
                            if (user.getProfilePicture() != null
                                    && !user.getProfilePicture().isEmpty()) {
                                String oldFilePath = uploadDir + user.getProfilePicture();
                            ...
                            // Save new profile picture - ensure path separator is correct
                            String filePath =
                                    uploadDir.endsWith(File.separator) ? uploadDir + newFilename
                                            : uploadDir + File.separator + newFilename;
                            File uploadFile = new File(filePath);
                            profilePicture.transferTo(uploadFile);
    ...
    /**
     * Change Password - Frontend only GET /user-management/profile/change-password
     */
    ...
    /**
     * Change Password - POST handler POST /user-management/profile/change-password
     */
    ...
    /**
     * View Users (Admin) - Frontend only GET /user-management/admin/users
     */
    ...
    public ModelAndView viewUsers(HttpSession session) {
        ...
        try {
            ...
            // If UserDAO.getAll() doesn't work, provide empty list
